...
O pagamento do seu pedido #{{ $data['order']['code'] }} não foi confirmado, por favor tente novamente, caso não consiga realizar o pagamento, entre em contato com a operadora do seu cartão.
