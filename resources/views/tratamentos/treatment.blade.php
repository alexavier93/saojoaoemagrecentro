...
@section('content')
    ...
    <div id="tratamentos">
        ...
        <div class="header" style="background: url('{{ asset('assets/images/banner-page/banner-01.jpg') }}')">
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <div class="item">
                            ...
                            <a href="{{ route('tratamentos.product', ['treatment' => $treatment->slug, 'category' => $category->slug, 'product' => $product->slug]) }}" class="product-image">
                                <div class="img">
                                    <img src="{{ asset('storage/'.$product->image) }}" title="{{ $product->title }}" alt="{{ $product->title }}">
                                </div>
                            </a>
                            @endif
                            @endforeach
