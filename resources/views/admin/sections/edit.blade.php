...
@section('content')
    ...
    <div class="page-header-content py-3">
        ...
        <ol class="breadcrumb mb-0 mt-4">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.sections.index') }}">Sessões</a></li>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.sections.update', ['section' => $section->id]) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ $section->title }}">
                                @error('title')
