...
@section('content')
    ...
    <div class="page-header-content py-3">
        ...
        <ol class="breadcrumb mb-0 mt-4">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.treatments.index') }}">Tratamentos</a></li>
        ...
        <div class="col-xl-12 col-lg-12 mb-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.treatments.update', ['treatment' => $treatment->id]) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ $treatment->title }}">
                                @error('title')
